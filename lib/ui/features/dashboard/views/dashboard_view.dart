...
class _DashboardViewState extends ConsumerState<DashboardView> with SingleTickerProviderStateMixin {
  ...
  /// ── Proactive Insight Cards Strip ────────────────────────────────────────
  Widget _buildProactiveInsightsSection() {
...
// ─── Proactive Insight Card Widget ───────────────────────────────────────────

class _ProactiveInsightCard extends StatefulWidget {
  final ProactiveInsight insight;
  final VoidCallback onDismiss;
  final VoidCallback onAction;

  const _ProactiveInsightCard({
    super.key,
  ...
  @override
  State<_ProactiveInsightCard> createState() => _ProactiveInsightCardState();
}

class _ProactiveInsightCardState extends State<_ProactiveInsightCard>
